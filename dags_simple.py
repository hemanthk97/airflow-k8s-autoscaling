...
with DAG(
    ...
    kubernetes_min_pod = [kubernetes_pod_operator.KubernetesPodOperator(
        ...
        image='docker.io/hemanthk0208/ktest:v3') for i in range(60)]


    kubernetes_min_pod_fruit = [kubernetes_pod_operator.KubernetesPodOperator(
        # The ID specified for the task.
        task_id='pod-fruit-t'+str(i),
        # Name of task you want to run, used to generate Pod ID.
        name='pod-fruit-t'+str(i),
        resources=pod_res,
        # Entrypoint of the container, if not specified the Docker container's
        # entrypoint is used. The cmds parameter is templated.
        cmds=["python", "fruit.py"],
        affinity=affinity_values,
        config_file='/home/airflow/composer_kube_config',
        # The namespace to run within Kubernetes, default namespace is
        # `default`. There is the potential for the resource starvation of
    ...
    hello_python >> goodbye_bash >> kubernetes_min_pod >> hello_python1 >> kubernetes_min_pod_fruit
